    ...
    return (
        <div className='Container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='fs-1 text-center '>We pioneered the discount broking model in India.
                    <br /> Now, we are breaking ground with our technology.
                </h1>
            </div>
            <div className='row p-5 mt-4 border-top text-muted' style={{ lineHeight: "1.8" }}>
                ...
                <div className='col-4 fs-4' style={{ marginLeft: "30px" }}>
