        ...
        <div className='Container border-top mt-5' style={{ backgroundColor: "rgb(250,250,250)" }}>
            <div className='row mt-5 '>
                ...
                <div className='col text-muted'>
                    ...
                    <br />
                    <a href='' style={{ textDecoration: "none" }} className='text-muted '>Product</a>
                    <br />
                ...
                <div className='col'>
                    ...
                    <br />
                    <a href='' style={{ textDecoration: "none" }} className='text-muted '>List of changes</a>
                    <br />
                ...
                <div className='col ' s>
                    <p>Account</p>
                    <a href='' style={{ textDecoration: "none" }} className='text-muted '>Open an accout</a>
                    <br />
            ...
            <div className='   col fs-6 mt-5 text-small text-muted'>
